...
function App() {
	...
	const handleReset = () => {
		if (window.confirm("Are you sure you want to reset the deck? This will remove all cards.")) {
			setDeck({ entries: {}, total: 0 });
		}
	};
	...
	return (
		<div className='h-screen w-screen bg-gradient-to-b from-indigo-950 to-slate-950'>
			...
			<div className='ml-auto mr-0 flex items-center gap-x-2'>
				<Button
					variant='outline'
					size='icon'
					onClick={handleReset}
